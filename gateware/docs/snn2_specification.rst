...
the FPGA. Volatile SRAM validation, the trained manifest, the full 4,096-sample
all-state RTL comparison, and frozen low/medium/high population-rate fixtures
remain named gates. See :doc:`snn2_v1_reference_rtl` for commands and the exact
validation scope.
