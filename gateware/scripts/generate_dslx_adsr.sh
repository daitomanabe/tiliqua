...
temporary_dir=$(mktemp -d "${TMPDIR:-/tmp}/tiliqua-dslx-adsr.XXXXXX")
trap 'rm -rf "$temporary_dir"' EXIT HUP INT TERM

source_file="$gateware_dir/dslx/adsr.x"
ir_file="$temporary_dir/adsr.ir"
verilog_file="$temporary_dir/tiliqua_dslx_adsr.v"
output_file="$gateware_dir/dslx/generated/tiliqua_dslx_adsr.v"
